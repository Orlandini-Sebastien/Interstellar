			...
			<View style={styles.container}>
				...
				<View style={styles.firstBloc}>
					...
					<View style={styles.bloc}>
						<Image
							resizeMode="cover"
							style={styles.interstellar}
							source={require('./assets/interstellar.jpg')}
						/>
						<View style={styles.aside}>
							<Text style={styles.textAside}>
								{' '}
								A team of explorers travel through a wormHole in space in an
								attempt to ensure humanity's survival
							</Text>
							<TouchableOpacity style={styles.textAside2} activeOpacity={0.8}>
								<Text style={styles.btn}>+ ADD TO WATCHLIST</Text>
							</TouchableOpacity>
						</View>
					</View>
